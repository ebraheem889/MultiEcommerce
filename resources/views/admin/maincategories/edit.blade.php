                                ...
                                <div class="form-group">
                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group mt-1">
                                                                    <input type="checkbox"  value="" name="category[0][active]"
                                                                        id="switcheryColor4"
                                        ...
                                        <div class="tab-content px-1 pt-1">
                                                ...
                                                <form class="form"
                                                      action="{{route('admin.maincategories.update',$cats -> id)}}"
                                                      method="POST"
                                                      enctype="multipart/form-data">
                                                    @csrf

                                                    <input name="id" value="{{$cats -> id}}" type="hidden">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="projectinput1"> اسم القسم
                                                                        - {{__('messages.'.$cats -> translation_lang)}} </label>
                                                            ...
                                                            <div class="col-md-6 hidden">
                                                                <div class="form-group">
                                                                    <label for="projectinput1"> أختصار
                                                                        اللغة {{__('messages.'.$cats -> translation_lang)}} </label>
                                                                    <input type="text" id="abbr"
                                                                           class="form-control"
                                                                           placeholder="  "
                                                                           value="{{$cats -> translation_lang}}"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mt-1">
                                                                    <input type="checkbox" value="1"
                                                                           ...
                                                                           id="switcheryColor4"
                                                                           class="switchery" data-color="success"
                                                                           @if($cats -> active == 1)checked @endif/>
                                                                    <label for="switcheryColor4"
                                                                           class="card-title ml-1">الحالة {{__('messages.'.$cats -> translation_lang)}} </label>
